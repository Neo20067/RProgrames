...
fin=open("samsungRawTweets.json","r")
data=fin.read()
fin.close()
x=json.loads(data)
print len(x)
...
for i in x:
    i=i.lower()
    if 'sumsunggalaxy' in i or 'S1' in i or 's2' in i or 'S3' in i or 'S4' in i or 'S6' in i or 'Note' in i or 'smartphones' in i or 'Mobile' in i or 'phone' in i or 'galaxy' in i:
        i=escHTML(i)
        i=remHyper(i)
        if i not in y:
            y.append(i)
...
fout=open('samsung_Tweets_2000.json','w')
