...
newTweetList=[]
#for word cloud purpose we create all words under one list
fout=open('samsungTweetWords.txt','w')
...
#*****************Rating method purpose************************
tweetRateList=[]
fout=open('samsungGalaxyWords.txt','w')
for tweet in newTweetList:
        rate=0
        fout.write(tweet)
        for word in tweet.split():
...
fout=open('rateSamsungAFINN.txt','w')
